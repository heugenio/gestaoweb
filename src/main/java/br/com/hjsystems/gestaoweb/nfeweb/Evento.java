...
if (display) JOptionPane.showMessageDialog(null, "Evento.eventoCancelamento - xml para assinar: ["+xml+"]"); 
...
if (display) JOptionPane.showMessageDialog(null, "Evento.eventoManifestacao - xml para assinar: ["+xml+"]"); 
