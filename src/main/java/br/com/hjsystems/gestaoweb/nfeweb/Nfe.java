...
import br.com.hjsystems.gestaoweb.nfeweb.ConsultaCadastro;
...
//JOptionPane.showMessageDialog(null, "Nfe.consultaCadastro() - entro no metodo . . .");		
		return ConsultaCadastro.consultaCadastro(consCad, valida, estado);
	...
	public static TEnviNFe montaNfe(TEnviNFe enviNFe, boolean valida) throws NfeException{
		...
		return env.montaNfe(enviNFe , valida);
