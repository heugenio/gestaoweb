...
public class NFeBuildAllCacerts {
	private static final String JSSECACERTS = "c:\\nfe\\NFeCacerts";
	...
	public static void main(String[] args) {
		...
		try {
		    ...
		    get("homologacao.nfe.fazenda.pr.gov.br", 443, ks);  //  "homologacao.nfe2.fazenda.pr.gov.br"
		    get("nfe-homologacao.svrs.rs.gov.br", 443, ks);  //  "homologacao.nfe.sefaz.rs.gov.br"
		    ...
		    get("hom.sefazvirtual.fazenda.gov.br", 443, ks);  //  "homologacao.nfe.sefazvirtual.rs.gov.br"
