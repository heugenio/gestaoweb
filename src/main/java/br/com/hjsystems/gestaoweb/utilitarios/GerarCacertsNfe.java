...
public class GerarCacertsNfe {
    ...
    private static final String JSSECACERTS = "c:/nfe/NFeCacerts";
    ...
    public boolean processar() {
        ...
        try {
            ...
            get("nfe.fazenda.pr.gov.br", 443, ks);  //  incluido em: 30/06/2017
            get("homologacao.nfe.fazenda.pr.gov.br", 443, ks);  //  "https://homologacao.nfe.fazenda.pr.gov.br"
            ...
            JOptionPane.showMessageDialog(null, "Erro ao tentar gerar o arq. NFeCacerts: "+e);
            retorno = false;
        }
        return retorno;
    }
