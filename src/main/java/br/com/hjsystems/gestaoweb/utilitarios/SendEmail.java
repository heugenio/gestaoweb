...
public class SendEmail {
	...
	public void sendEmail(String from, String to, String subject, String message) {
		...
		auth = new SimpleAuth ("portoinfo","33425492");  //("seuusuarioparalogin","suasenhaparalogin");
		...
		try {
			 ...
			 */
			tr.connect(mailSMTPServer, "portoinfo", "33425492");
			...
			JOptionPane.showMessageDialog(null, ">> Erro: Envio Mensagem: "+e);
			e.printStackTrace();
		}
	}
}
