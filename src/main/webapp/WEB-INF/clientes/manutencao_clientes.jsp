...
<div id="modalCliente" class="modal modal-fixed-footer">
    ...
    <div class="modal-footer">
        <button
           class="modal-action modal-close waves-effect waves-green btn-flat">Cancelar</button>
        <button
           class="waves-effect waves-green btn-flat hide" id="btnSalvarCliente">Salvar</button>
        <button
           class="waves-effect waves-green btn-flat hide" id="btnAtualizarCliente" >Atualizar</button>
    </div>
</div>
<!--Fim do Modal -->
