...
$(function() {
	...
	function getCollapseIndex() {
		$("#slide-out > li > ul > li > a.collapsible-header").each(
				function(index) {
	...
	function checkbox_check(el) {
		if (!$(el).is(':checked')) {
			...
			$(el).next().css('text-decoration', 'line-through'); // or
																	// addClass
		}
	}
	...
	$('.menu-sidebar-collapse').sideNav({
		...
		menuOut : false
	// Set if default menu open is true
	});
